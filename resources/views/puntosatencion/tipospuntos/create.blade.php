<div class="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full h-screen bg-black bg-opacity-50 p-4">
    <div class="w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                wire:click="close_create()">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Agregar Tipo Punto de Atencion</h3>
                <form wire:submit.prevent="store()" class="space-y-6">
                    <div>
                        ...
                        <label for="descripcion"
                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Decripción:</label>
                        <textarea type="text" id="descripcion" wire:model="descripcion"
