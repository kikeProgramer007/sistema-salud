            ...
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
                <a href="#" class="flex items-center">
                    <div class="w-12 h-12 overflow-hidden rounded-full sm:w-12 sm:h-12">
                        <img src="{{asset('logo.png')}}" alt="Flowbite Logo" class="object-cover w-full h-full" />
                    </div>
                    <span class="self-center ml-2 text-xl font-semibold whitespace-nowrap dark:text-white">SSEM</span>
                </a>
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
                    Una nueva alternativa a tu hospital preferido</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">El sistema que cambiara los resultados ante las enfermedades virales.</p>

            </div>
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://cdn.bolivia.com/sdi/2018/09/26/7-curiosidades-de-santa-cruz-673897.jpg" alt="mockup">
            </div>
        </div>
    </section>
            ...
            <div class="container mx-auto py-14">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/87945981?v=4" alt="">
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/95058787?v=4" alt="">

                            <div class="mt-4 sm:mx-4 sm:mt-0">
                                <h1
                                    class="text-xl font-semibold text-gray-700 capitalize md:text-2xl group-hover:text-white">Ricardo Ripaa</h1>
                        ...
                        <p class="mt-4 text-gray-500 capitali.</p>ze group-hover:text-gray-300">Creative individuals who focus on backend development prioritize building robust and efficient systems that meet user needs and deliver smooth, seamless functionality. 
